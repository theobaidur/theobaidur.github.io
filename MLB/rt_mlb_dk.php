...
foreach(array('DraftKings' => "http://www.rotowire.com/daily/MLB/value-report.htm?site=DraftKings") as $section => $url){
  //echo $url . "\n";
...
//    unset($item['Player Name']);
  ...
  $file_name = 'MLB_' . $section . '_RT.json';
