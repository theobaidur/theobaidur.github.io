...
SmartInfoWindow.prototype.draw = function() {
  ...
  var widthLess = 0;
   ...
   this.height_ = 210;
   this.offsetX_ = -230;
   this.offsetY_ = -(this.height_+13);
   paddingLeft = 20;
   widthLess = 20; 
   
  // Now position our DIV based on the DIV coordinates of our bounds
  this.div_.style.maxWidth = this.width_ + 'px';
...
SmartInfoWindow.prototype.createElement = function() {
  ...
  if (!div) {
	...
	/*This is additiona styling specific for the job*/
	contentDiv.style.margin = "-30px 0px 0px -5px";
	contentDiv.style.padding = '5px';
	contentDiv.className = "borderbox";	
   ...
   if (typeof this.content_ == 'string') {
    ...
    bottomArrow.src = 'img/arrow.png';
    bottomArrow.style.width = '20px';
    bottomArrow.style.height = '20px';	
	bottomArrow.style.marginTop = "-5px";
    bottomDiv.appendChild(bottomArrow);	
